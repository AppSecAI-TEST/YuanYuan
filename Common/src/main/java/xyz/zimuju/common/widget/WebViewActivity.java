...
public class WebViewActivity extends BaseActivity implements OnBottomDragListener, OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        url = StringUtils.getCorrectUrl(getIntent().getStringExtra(INTENT_URL));
    ...
    public void initData() {
        ...
        wvWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                tvBaseTitle.setText(StringUtils.getTrimedString(wvWebView.getUrl()));
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                tvBaseTitle.setText(StringUtils.getTrimedString(wvWebView.getTitle()));
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.tvBaseTitle) {
            toActivity(EditTextInfoWindow.createIntent(context
                    ...
                    , StringUtils.getTrimedString(tvBaseTitle)
                    , wvWebView.getUrl()),
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case REQUEST_TO_EDIT_TEXT_WINDOW:
                if (data != null) {
                    wvWebView.loadUrl(StringUtils.getCorrectUrl(data.getStringExtra(EditTextInfoWindow.RESULT_VALUE)));
                }
                break;
        }
    }
