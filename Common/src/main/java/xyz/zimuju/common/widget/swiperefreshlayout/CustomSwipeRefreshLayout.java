...
public class CustomSwipeRefreshLayout extends ViewGroup {
    ...
    public CustomSwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        final TypedArray a2 = context.obtainStyledAttributes(attrs, R.styleable.CustomSwipeRefreshLayout);
        SwipeRefreshLayoutDirection direction
                = SwipeRefreshLayoutDirection.getFromInt(a2.getInt(R.styleable.CustomSwipeRefreshLayout_srl_direction, 0));
