...
public class CacheManager2 {
    ...
    private static CacheManager2 mInstance = null;
    ...
    private CacheManager2(Context context, Strategy strategy) {
    ...
    public static CacheManager2 getInstance(Context context, Strategy strategy) {
        if (mInstance == null) {
            synchronized (CacheManager2.class) {
                if (mInstance == null) {
                    mInstance = new CacheManager2(context.getApplicationContext(), strategy);
                }
            }
        } else {
