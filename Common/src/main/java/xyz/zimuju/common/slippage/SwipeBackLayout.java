...
import xyz.zimuju.common.helper.ViewDragHelper;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        int shadowLeft = a.getResourceId(R.styleable.SwipeBackLayout_shadow_left, R.mipmap.shadow_left);
        int shadowRight = a.getResourceId(R.styleable.SwipeBackLayout_shadow_right, R.mipmap.shadow_right);
        int shadowBottom = a.getResourceId(R.styleable.SwipeBackLayout_shadow_bottom, R.mipmap.shadow_bottom);
