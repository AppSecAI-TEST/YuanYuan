...
public abstract class MRecyclerViewAdapter<M> extends RecyclerView.Adapter<RecyclerViewHolder> {
    ...
    public MRecyclerViewAdapter(RecyclerView recyclerView, int itemLayoutId) {
     ...
     */
    protected void setItemChildListener(MViewHolderHelper viewHolderHelper) {
    }
