package xyz.zimuju.common.contrant;

public class UserFieldsConstants {
    ...
    public static final String NAME_USUAL_ADDRESS = "常用地址";
    public static final String NAME_MAIL_ADDRESS = "收件地址";
