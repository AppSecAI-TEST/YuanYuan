package xyz.zimuju.gankio.module.mine;
...
import xyz.zimuju.gankio.api.SinaApiService;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void setUpToolBar() {
        Toolbar mToolbar = (Toolbar) findViewById(xyz.zimuju.library.R.id.toolbar);
        ...
        mTextSwitcher = (TextSwitcher) findViewById(xyz.zimuju.library.R.id.textSwitcher);
        mTextSwitcher.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ...
                textView.setTextAppearance(context, xyz.zimuju.library.R.style.WebTitle);
