package com.example.jingbin.cloudreader.surface.one;
...
import com.example.jingbin.cloudreader.util.StringFormatUtil;
import com.example.jingbin.cloudreader.widget.CallBack_ScrollChanged;
import com.example.jingbin.cloudreader.widget.DiscoverScrollView;
import com.example.jingbin.cloudreader.widget.test.RCVListAdapter;
import com.example.jingbin.cloudreader.widget.test.StatusBarUtils;

import java.util.Arrays;

import static com.example.jingbin.cloudreader.widget.statusbar.StatusBarUtil.getStatusBarHeight;
