package xyz.zimuju.cloudreader.surface.one;
...
import xyz.zimuju.cloudreader.widget.DiscoverScrollView;
import xyz.zimuju.cloudreader.widget.statusbar.StatusBarUtil;
import xyz.zimuju.cloudreader.widget.test.RCVListAdapter;
import xyz.zimuju.cloudreader.widget.test.StatusBarUtils;
...
//            actionBar.setSubtitle("主演：" + StringFormatUtil.formatName(subjectsBean.getCasts()));
    ...
    private void initRecyclerView() {
        ...
        header.getLayoutParams().height = getResources().getDimensionPixelOffset(R.dimen.new_home_header_size) - StatusBarUtil.getStatusBarHeight(this);
    ...
    private void initNewSlidingParams() {
        ...
        int navBarHeight = getResources().getDimensionPixelOffset(R.dimen.nav_bar_height) + 2 * StatusBarUtil.getStatusBarHeight(this);
